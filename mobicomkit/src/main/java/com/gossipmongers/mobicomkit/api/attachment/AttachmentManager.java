...
package com.gossipmongers.mobicomkit.api.attachment;
...
//            }
        ...
        if (downloaderTask != null) {
            ...
            synchronized (sInstance) {
                ...
                if (null != thread) {
                    ...
                    com.gossipmongers.mobicomkit.api.conversation.Message message = documentView ? downloaderTask.getAttachmentView().getMessage() : downloaderTask.getPhotoView().getMessage();
    ...
    static public AttachmentTask startDownload(
            ...
            boolean cacheFlag, com.gossipmongers.mobicomkit.api.conversation.Message message, MediaDownloadProgressHandler handler, Context context) {
