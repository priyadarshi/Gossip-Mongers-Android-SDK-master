package com.gossipmongers.mobicomkit.uiwidgets.conversation.fragment;
...
import com.gossipmongers.mobicomkit.api.conversation.AlMessageReportTask;
import com.gossipmongers.mobicomkit.api.conversation.MessageBuilder;
import com.gossipmongers.mobicomkit.api.conversation.MessageDeleteTask;
import com.gossipmongers.mobicomkit.exception.ApplozicException;
import com.gossipmongers.mobicomkit.listners.AlCallback;
import com.gossipmongers.mobicomkit.listners.MediaUploadProgressHandler;
import com.gossipmongers.mobicomkit.uiwidgets.conversation.activity.ALSendMessageInterface;
import com.gossipmongers.mobicomkit.uiwidgets.conversation.richmessaging.RichMessageActionProcessor;
import com.gossipmongers.mobicomkit.uiwidgets.conversation.richmessaging.callbacks.ALRichMessageListener;
import com.gossipmongers.mobicomkit.uiwidgets.conversation.richmessaging.webview.AlWebViewActivity;
import com.gossipmongers.mobicommons.file.ALFileProvider;
...
import com.gossipmongers.mobicomkit.ApplozicClient;
...
import com.gossipmongers.mobicomkit.api.account.user.User;
import com.gossipmongers.mobicomkit.api.account.user.UserBlockTask;
import com.gossipmongers.mobicomkit.api.attachment.AttachmentView;
import com.gossipmongers.mobicomkit.api.attachment.FileClientService;
import com.gossipmongers.mobicomkit.api.attachment.FileMeta;
import com.gossipmongers.mobicomkit.api.conversation.ApplozicMqttIntentService;
...
import com.gossipmongers.mobicomkit.api.conversation.selfdestruct.DisappearingMessageTask;
import com.gossipmongers.mobicomkit.api.conversation.service.ConversationService;
import com.gossipmongers.mobicomkit.api.notification.MuteNotificationAsync;
import com.gossipmongers.mobicomkit.api.notification.MuteNotificationRequest;
import com.gossipmongers.mobicomkit.api.notification.NotificationService;
import com.gossipmongers.mobicomkit.api.notification.MuteUserNotificationAsync;
import com.gossipmongers.mobicomkit.api.people.UserIntentService;
import com.gossipmongers.mobicomkit.broadcast.BroadcastService;
import com.gossipmongers.mobicomkit.channel.database.ChannelDatabaseService;
...
import com.gossipmongers.mobicomkit.contact.MobiComVCFParser;
import com.gossipmongers.mobicomkit.contact.VCFContactData;
import com.gossipmongers.mobicomkit.feed.ApiResponse;
import com.gossipmongers.mobicomkit.feed.TopicDetail;
import com.gossipmongers.mobicomkit.uiwidgets.AlCustomizationSettings;
import com.gossipmongers.mobicomkit.uiwidgets.ApplozicSetting;
import com.gossipmongers.mobicomkit.uiwidgets.R;
import com.gossipmongers.mobicomkit.uiwidgets.async.AlMessageMetadataUpdateTask;
import com.gossipmongers.mobicomkit.uiwidgets.attachmentview.AlBitmapUtils;
import com.gossipmongers.mobicomkit.uiwidgets.attachmentview.ApplozicAudioManager;
import com.gossipmongers.mobicomkit.uiwidgets.attachmentview.ApplozicAudioRecordManager;
import com.gossipmongers.mobicomkit.uiwidgets.conversation.AlLinearLayoutManager;
import com.gossipmongers.mobicomkit.uiwidgets.conversation.ConversationUIService;
import com.gossipmongers.mobicomkit.uiwidgets.conversation.DeleteConversationAsyncTask;
import com.gossipmongers.mobicomkit.uiwidgets.conversation.MessageCommunicator;
import com.gossipmongers.mobicomkit.uiwidgets.conversation.MobicomMessageTemplate;
import com.gossipmongers.mobicomkit.uiwidgets.conversation.UIService;
import com.gossipmongers.mobicomkit.uiwidgets.conversation.activity.ChannelInfoActivity;
import com.gossipmongers.mobicomkit.uiwidgets.conversation.activity.ConversationActivity;
import com.gossipmongers.mobicomkit.uiwidgets.conversation.activity.MobiComKitActivityInterface;
import com.gossipmongers.mobicomkit.uiwidgets.conversation.activity.RecyclerViewPositionHelper;
import com.gossipmongers.mobicomkit.uiwidgets.conversation.adapter.ApplozicContextSpinnerAdapter;
import com.gossipmongers.mobicomkit.uiwidgets.conversation.adapter.DetailedConversationAdapter;
import com.gossipmongers.mobicomkit.uiwidgets.conversation.adapter.MobicomMessageTemplateAdapter;
import com.gossipmongers.mobicomkit.uiwidgets.conversation.richmessaging.AlRichMessage;
import com.gossipmongers.mobicomkit.uiwidgets.people.fragment.UserProfileFragment;
import com.gossipmongers.mobicomkit.uiwidgets.uilistener.ALProfileClickListener;
import com.gossipmongers.mobicomkit.uiwidgets.uilistener.ALStoragePermission;
import com.gossipmongers.mobicomkit.uiwidgets.uilistener.ALStoragePermissionListener;
import com.gossipmongers.mobicomkit.uiwidgets.uilistener.ContextMenuClickListener;
import com.gossipmongers.mobicomkit.uiwidgets.uilistener.CustomToolbarListener;
import com.gossipmongers.mobicommons.ApplozicService;
import com.gossipmongers.mobicommons.commons.core.utils.DateUtils;
import com.gossipmongers.mobicommons.commons.core.utils.LocationUtils;
import com.gossipmongers.mobicommons.commons.core.utils.Utils;
import com.gossipmongers.mobicommons.commons.image.ImageCache;
import com.gossipmongers.mobicommons.commons.image.ImageLoader;
import com.gossipmongers.mobicommons.commons.image.ImageUtils;
import com.gossipmongers.mobicommons.emoticon.EmojiconHandler;
...
import com.gossipmongers.mobicommons.people.channel.ChannelUserMapper;
import com.gossipmongers.mobicommons.people.channel.ChannelUtils;
