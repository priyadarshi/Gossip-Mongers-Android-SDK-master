package com.gossipmongers.mobicomkit.uiwidgets;
...
public class DimensionsUtils {
    ...
    public static void checkDisplaySize(Context context, Configuration newConfiguration) {
        try {
            ...
            Utils.printLog(context, "DimensionUtils", "Display size = " + displaySize.x + " " + displaySize.y + " " + displayMetrics.xdpi + "x" + displayMetrics.ydpi);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
